...
### 2024-08-30
* add cursorignore
* removing build folder from being tracked
...
### 2024-05-02
* deleted:    dist/Sentiment-Analysis.exe
...
* ignore html md
* modified:   dist/Sentiment-Analysis.exe
...
* fixed token_buffer arg problem in .exe
* commiting cleaned (master) .exe in order to switch
...
### 2024-04-08
* .exe uses milo's api key for now
...
* Update README.md
* Updated executable with refactor and error handling fixes
